          ...
          <div className={"flex flex-col gap-2"}>
            {result.length > 0 ? (
              result.map((item: any, index: number) => (
                <Link
                  className={
                    "flex w-full cursor-pointer items-start gap-3 px-5 py-2.5 hover:bg-light-700/50 dark:hover:bg-dark-500/50"
                  }
                ...
                >
                  ...
                  <div className={"flex flex-col"}>
                    <p
                      className={
                        " body-medium text-dark200_light800 line-clamp-1"
                      }
                    >
                      {item.title}
                    </p>
                    <p
                      className={
                        " text-light400_light500 small-medium mt-1 font-bold capitalize"
                      }
                    >
                      {item.type}
                    </p>
